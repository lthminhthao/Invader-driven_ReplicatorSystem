...
"""Compute the dynamics for a n strain system.
    ...
    """
def simu(T, fit, z0, T_threshold = None, V_threshold = 5*(10**-3), **kwargs):
...
def plot_dynamics(T, fit, z0, isplot = True, ax = None, **kwargs):
    
    details = T*10
    fit, resultat, nc = simu(T, fit, z0)
        
    D = kwargs.pop('D', 1)
    istitle = kwargs.pop('istitle', True)
    
    T = kwargs.pop('T',resultat.t[-1])
    V_threshold = kwargs.pop('V_threshold', 5*(10**-3))
